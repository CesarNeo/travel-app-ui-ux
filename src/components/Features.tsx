...
function FeatureItem({ data: { title, description, icon } }: FeatureItemProps) {
  return (
    <li className="flex w-full flex-1 flex-col items-start">
      ...
      <p className="regular-16 mt-5 bg-white/80 text-gray-30 lg:mt-[2.4375rem] lg:bg-transparent">
        {description}
      </p>
    </li>
  )
